...
<!--Author:
  ...
  Purpose:  This program lists the first and last names of all sales employees.
      Modify this so that, instead of using a loop to display the names, the program simply displays a paragraph that reports the number of sales staff, for example "There are 4 sales staff". Use a MySQL function to obtain the number of sales staff. 
...
<html>
  ...
  <body>
    ...
    if (!$connect) {
      ...
      $userQuery = "SELECT COUNT(*) AS staffCount FROM personnel WHERE jobTitle='sales' ";
    ...
    print("<p>There are $staffCount sales staff.</p>");
    }
